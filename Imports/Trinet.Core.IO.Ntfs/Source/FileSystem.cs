...
namespace Trinet.Core.IO.Ntfs
{
	...
	public static class FileSystem
	{
		...
		/// </exception>
		public static bool AlternateDataStreamExists(FileSystemInfo file, string streamName)
		{
			if (null == file) throw new ArgumentNullException("file");
		...
		/// </exception>
		public static AlternateDataStreamInfo GetAlternateDataStream(FileSystemInfo file, string streamName, FileMode mode)
		{
			if (null == file) throw new ArgumentNullException("file");
			if (!file.Exists) throw new FileNotFoundException(null, file.FullName);
			SafeNativeMethods.ValidateStreamName(streamName);
		...
		/// The caller does not have the required permission, or the file is read-only.
		/// </exception>
		public static AlternateDataStreamInfo GetAlternateDataStream(FileSystemInfo file, string streamName)
		{
