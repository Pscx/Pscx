...
using Pscx.Win.Interop.Console;
...
using Size = Pscx.Win.Interop.Console.Size;
...
namespace Pscx.Win.Interop
{
    ...
    public static partial class NativeMethods
    {
        ...
        public static extern int GetRunningObjectTable(int reserved,
            out ComTypes.IRunningObjectTable prot);

        [DllImport(Dll.Ole32)]
        public static extern int CreateBindCtx(int reserved,
            out ComTypes.IBindCtx ppbc);
        ...
        #region UrlMon
        [DllImport(Dll.UrlMon, CharSet = CharSet.Auto)]
        private static extern UInt32 FindMimeFromData( UInt32 pBC, [MarshalAs(UnmanagedType.LPStr)] string pwzUrl, 
            ...
            [MarshalAs(UnmanagedType.LPStr)] string pwzMimeProposed, UInt32 dwMimeFlags, ref UInt32 ppwzMimeOut, UInt32 dwReserverd);
        #endregion
