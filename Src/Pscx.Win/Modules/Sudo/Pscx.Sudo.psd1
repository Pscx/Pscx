#
# Original module manifest for module 'gsudoModule'
# Adjusted name to fit with PSCX style - see /Imports/GSudo/Win folder for project sources
#
