...
namespace Wintellect.PowerCollections {
    ...
    /// items of the same type, and returns a boolean value representing 
    ...
    public static class Algorithms {
        ...
        private class LexicographicalComparerClass<T> : IComparer<IEnumerable<T>> {
            ...
            public override bool Equals(object obj) {
                return obj is LexicographicalComparerClass<T> comparerClass && itemComparer.Equals(comparerClass.itemComparer);
            }
        ...
        private class ReverseComparerClass<T> : IComparer<T> {
            ...
            public override bool Equals(object obj) {
                return obj is ReverseComparerClass<T> comparerClass && this.comparer.Equals(comparerClass.comparer);
            }
...
#pragma warning restore RS1024
        ...
        /// <seealso cref="EqualCollections{T}(System.Collections.Generic.IEnumerable{T},System.Collections.Generic.IEnumerable{T})"/>
